...
print DATAPATH+'/impressions/week'+str(week)+'.csv'
with open(DATAPATH+'/impressions/week'+str(week)+'.csv', 'rb') as f:
...
with open(DATAPATH+'/impressions/week'+str(week)+'b.csv', 'w') as f:
	f.write(str(header)+"\n")
	for row in B:
		f.write(str(row)+"\n")
